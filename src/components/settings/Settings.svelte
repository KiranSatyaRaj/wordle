...
<div class="outer">
	<div class="settings-top">
		...
		<div class="links">
			<a href="https://github.com/kiransatyaraj/wordle" target="_blank" rel="noreferrer">
				Leave a ⭐
			</a>
			<a href="https://github.com/kiransatyaraj/wordle/issues" target="_blank" rel="noreferrer">
				Report a Bug
			</a>
		</div>
	</div>
